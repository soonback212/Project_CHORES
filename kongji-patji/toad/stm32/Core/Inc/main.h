...
/* Private defines -----------------------------------------------------------*/
#define Front_Infrared1_Pin GPIO_PIN_0
#define Front_Infrared1_GPIO_Port GPIOC
#define Front_Infrared2_Pin GPIO_PIN_1
...
#define Left_PWM_Pin GPIO_PIN_13
#define Left_PWM_GPIO_Port GPIOD
#define Right_PWM_Pin GPIO_PIN_14
#define Right_PWM_GPIO_Port GPIOD
