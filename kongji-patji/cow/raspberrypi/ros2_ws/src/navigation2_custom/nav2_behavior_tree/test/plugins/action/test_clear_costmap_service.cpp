...
public:
  static void SetUpTestCase()
  {
    ...
    config_->blackboard->set<int>("number_behaviors", 0);
  ...
  void SetUp() override
  {
    config_->blackboard->set("number_behaviors", 0);
  }
...
TEST_F(ClearEntireCostmapServiceTestFixture, test_tick)
{
  ...
  EXPECT_EQ(config_->blackboard->get<int>("number_behaviors"), 0);
  EXPECT_EQ(tree_->rootNode()->executeTick(), BT::NodeStatus::SUCCESS);
  EXPECT_EQ(config_->blackboard->get<int>("number_behaviors"), 1);
}
